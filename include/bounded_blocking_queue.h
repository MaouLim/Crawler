/*
 * Created by Maou Lim on 2018-07-03
 */

#ifndef _CRAWLER_BOUNDED_BLOCKING_QUEUE_H_
#define _CRAWLER_BOUNDED_BLOCKING_QUEUE_H_
...
namespace tools {
	...
	/*
	 * A thread-safe queue(bounded) for message passing.
	 */
	template <
		typename _Tp, 
	...
	/* 
	 * Optimized version for smart_ptr type
	 */
